...
5. For frontend/UI work, read `docs/AGENT_DESIGN_SKILLS.md` and `DESIGN.md`; use the clean/professional CWS internal SaaS control-plane design system.
...
- UI work also requires `cd frontend && npm run build`, browser/console/responsive review, and a short scorecard against `DESIGN.md`.
